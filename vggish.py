...
# weight path
WEIGHTS_PATH = 'weight/vggish_audioset_weights_without_fc2.h5'
WEIGHTS_PATH_TOP = 'weight/vggish_audioset_weights.h5'
...
def VGGish(load_weights=True, weights='audioset',
    ...
    if input_shape is None:
        if load_weights:
            input_shape = (96, params.NUM_BANDS, 1)
        else:
    ...
    if load_weights:
        if weights == 'audioset':
            ...
            print("=== vggish is not using audioset weights directly")
